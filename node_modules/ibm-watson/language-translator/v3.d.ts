...
declare class LanguageTranslatorV3 extends BaseService {
     ...
     */
    deleteDocument(params: LanguageTranslatorV3.DeleteDocumentParams): Promise<LanguageTranslatorV3.Response<LanguageTranslatorV3.EmptyObject>>;
    /**
     ...
     */
    getTranslatedDocument(params: LanguageTranslatorV3.GetTranslatedDocumentParams): Promise<LanguageTranslatorV3.Response<NodeJS.ReadableStream>>;
}
/*************************
 * interfaces
 ************************/
declare namespace LanguageTranslatorV3 {
    ...
    namespace CreateModelConstants {
        /** The content type of forcedGlossary. */
        enum ForcedGlossaryContentType {
        ...
        /** The content type of parallelCorpus. */
        enum ParallelCorpusContentType {
            APPLICATION_X_TMX_XML = "application/x-tmx+xml",
            APPLICATION_XLIFF_XML = "application/xliff+xml",
            TEXT_CSV = "text/csv",
            TEXT_TAB_SEPARATED_VALUES = "text/tab-separated-values",

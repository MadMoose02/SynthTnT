...
var SpeechToTextV1 = /** @class */ (function (_super) {
    ...
    SpeechToTextV1.prototype.trainLanguageModel = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['customizationId'];
        var _validParams = ['customizationId', 'wordTypeToAdd', 'customizationWeight', 'strict', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    SpeechToTextV1.prototype.addWord = function (params) {
        ...
        var _validParams = ['customizationId', 'wordName', 'word', 'soundsLike', 'displayAs', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
